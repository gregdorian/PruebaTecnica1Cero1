...
namespace WebMVCPrueba.Controllers
{
    public class MunicipiosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CodigoMunicipio,NombreMunicipio")] Municipio municipio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CodigoMunicipio,NombreMunicipio")] Municipio municipio)
        {
            if (ModelState.IsValid)
            {
